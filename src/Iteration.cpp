...
Iteration& Iteration::operator=(Iteration&& i)
{
...
float Iteration::time() const
{
    return boost::get<float>(getAttribute("time"));
}

Iteration Iteration::setTime(float time)
{
    setAttribute("time", time);
    return *this;
}

float Iteration::dt() const
{
    return boost::get<float>(getAttribute("dt"));
}

Iteration Iteration::setDt(float dt)
{
    setAttribute("dt", dt);
    return *this;
}
...
Iteration Iteration::setTimeUnitSI(double timeUnitSI)
{
