...
# breathe config
breathe_projects = { 'libopenPMD': '../xml' }
breathe_default_project = 'libopenPMD'
...
project = u'libopenPMD'
copyright = u'2017, The openPMD Community'
...
htmlhelp_basename = 'libopenPMDdoc'
...
latex_documents = [
    (master_doc, 'libopenPMD.tex', u'libopenPMD Documentation',
...
man_pages = [
    (master_doc, 'libopenPMD', u'libopenPMD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'libopenPMD', u'libopenPMD Documentation',
     author, 'libopenPMD', 'C++ and Python APIs for the openPMD meta-standard',
     """
