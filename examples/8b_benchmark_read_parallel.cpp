...
int main(int argc, char *argv[])
{
    ...
    if (argc < 3)
    {
        if (input.m_MPIRank == 0)
            std::cout << "Usage: " << argv[0] << " input_file_prefix pattern"
                      << std::endl;
        MPI_Finalize();
        return 0;
    }

    {
        ...
        else if (types[0] == 's')
        {
            if (types[1] == 'x')
                ...
                std::cout << "For pattern 's' you should provide the dimension "
                             "as well: sx, sy, or sz"
                          << std::endl;
        }
        else if (types[0] == 'f')
        {
            if (types[1] == 'x')
                ...
                std::cout << "For pattern 'f' you should provide the dimension "
                             "as well: fx, fy, or fz"
                          << std::endl;
        }
        else
